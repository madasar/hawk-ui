...
public class HView extends ViewPart {
	...
	public void createPartControl(Composite parent) {
		...
		viewer.setContentProvider(HManager.getInstance());
	...
	private void makeActions() {
        ...
        pause.setImageDescriptor(ImageDescriptor.createFromURL(
                FileLocator.find(FrameworkUtil.getBundle(this.getClass()),
                        new Path("icons/pause.gif"),
                                 null)));
		...
		add = new Action() {
			public void run() {
				IWizardDescriptor descriptor = PlatformUI.getWorkbench()
						   .getNewWizardRegistry().findWizard("hawk.ui.wizard.HawkNewWizard");
				   if  (descriptor != null) {
